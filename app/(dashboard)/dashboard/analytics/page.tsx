          ...
          >
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data.clicksByDay} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                ...
                <ChartTooltip content={<ChartTooltipContent labelKey="date" nameKey="clicks" />} />
                <Line
                  type="monotone"
                  dataKey="clicks"
            ...
            >
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data.topLinks} layout="vertical" margin={{ left: 0, right: 20 }}>
                  ...
                  <ChartTooltip content={<ChartTooltipContent labelKey="title" nameKey="clicks" />} />
                  <Bar dataKey="clicks" fill="var(--color-clicks)" radius={[0, 4, 4, 0]} name="Clicks" />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </CardContent>
            ...
            >
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data.clicksByWeather} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                  ...
                  />
                  <Bar dataKey="clicks" radius={[4, 4, 0, 0]} name="Clicks">
